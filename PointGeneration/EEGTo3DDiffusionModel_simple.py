...
from eeg_data_process.GAN import PointCloudDiscriminator, EnhancedPointCloudDiscriminator, ImprovedPointCloudDiscriminator


from Mind2Cloud.Tiger_Transformer import Tiger_Transformer_custom
...
class EEGTo3DDiffusionModel(ModelMixin):
    ...
    def compute_eeg_loss(self, pc, cond, labels, shape_c=None):
        ...
        # print("noise_pred shape", noise_pred.shape)  # ([48, 8192, 3])
    ...
    def generate_eeg(self, num_points, cond, shape_c=None, fea_list=None, labels=None,
        ...
        for i, t in enumerate(progress_bar):
            ...
            # Forward
            noise_pred = self.point_cloud_model(x_t_input.transpose(1, 2), t.reshape(1).expand(B))
