...
import numpy as np
###
def data_organization(sub='sub04'):
    root_path = '/data1/hxf/neuro-3D-main/EEG_3Datasets/EEGdata/'
    print(root_path)
    ...
    for npy_name in npy_name_list:
        ...
        if os.path.exists(save_arr_name):
            ...
            return
        print(sub)
        print(data_array.shape, label_arr.shape)  # (1728, 64, 250) (1728,)
        result_dir = {}
        ...
        for key in sort_keys:
            ...
            if key[-2:] == '08' or key[-2:] == '09':
                print(data_arr_one_cls.shape)  # (4, 64, 250)
